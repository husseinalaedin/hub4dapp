      ...
      mainHeader: {
        backgroundColor:
          ...
          mainBody: {
            ...
            paddingTop: `${
              small ? "0px" : medium ? "15px" : "20px"
            } !important`, //small ? 0 : medium ? 15 : 20,
          ...
          AiGenericMessageHeaderEditMode: {
            ...
            color:
              colorScheme === "dark" ? "white" : theme.colors.dark[8],
          },
